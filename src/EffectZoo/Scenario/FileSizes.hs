...
benchmarks =
  bgroup
    ...
    ( do
        ( name, program ) <-
          [ ( "EffectZoo.Scenario.FileSizes.SimpleEffects.Main", SimpleEffects.calculateFileSizes )
          , ( "EffectZoo.Scenario.FileSizes.FreerSimple.Main", FreerSimple.calculateFileSizes )
          , ( "EffectZoo.Scenario.FileSizes.FusedEffects.Main", FusedEffects.calculateFileSizes )
